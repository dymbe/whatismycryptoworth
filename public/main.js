...
var _dymbe$whatismycryptoworth$Main$floatToStringOrError = F2(
...
var _dymbe$whatismycryptoworth$Main$maybeFloatToMaybeString = function ($float) {
	var _p1 = $float;
	if (_p1.ctor === 'Just') {
		return _elm_lang$core$Maybe$Just(
...
var _dymbe$whatismycryptoworth$Main$stringOrError = F2(
...
var _dymbe$whatismycryptoworth$Main$outputRow = F2(
...
var _dymbe$whatismycryptoworth$Main$inputRow = F3(
...
var _dymbe$whatismycryptoworth$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _dymbe$whatismycryptoworth$Main$ddecodeCryptoPrice = function (fiat) {
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				'price_',
				_elm_lang$core$String$toLower(fiat)),
			_elm_lang$core$Json_Decode$string));
};
var _dymbe$whatismycryptoworth$Main$getOutputText = function (inputText) {
	var result = _elm_lang$core$String$toInt(inputText);
	var _p3 = result;
	if (_p3.ctor === 'Ok') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _dymbe$whatismycryptoworth$Main$zeroFloatIfNothing = function ($float) {
	var _p4 = $float;
	if (_p4.ctor === 'Just') {
		return _p4._0;
	} else {
...
var _dymbe$whatismycryptoworth$Main$stringToMaybeFloat = function (str) {
	var result = _elm_lang$core$String$toFloat(str);
	var _p5 = result;
	if (_p5.ctor === 'Ok') {
...
var _dymbe$whatismycryptoworth$Main$stringToFloatOrZero = function (string) {
...
var _dymbe$whatismycryptoworth$Main$stringOrEmpty = function (str) {
	var _p7 = str;
	if (_p7.ctor === 'Just') {
		return _p7._0;
	} else {
...
var _dymbe$whatismycryptoworth$Main$resultRow = function (model) {
	var _p8 = model.valueUSD;
	if (_p8.ctor === 'Just') {
		var _p11 = _p8._0;
		var _p9 = function () {
			var _p10 = model.valueFiat;
			if (_p10.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: _p10._0,
					_1: _dymbe$whatismycryptoworth$Main$stringOrEmpty(model.fiat)
				};
			} else {
				return {ctor: '_Tuple2', _0: _p11, _1: 'USD'};
			}
		}();
		var valueFiat = _p9._0;
		var fiat = _p9._1;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_cuducos$elm_format_number$FormatNumber$format, _cuducos$elm_format_number$FormatNumber_Locales$usLocale, model.amount),
									A2(
										_elm_lang$core$Basics_ops['++'],
										' ',
										A2(
											_elm_lang$core$Basics_ops['++'],
											_dymbe$whatismycryptoworth$Main$stringOrEmpty(model.cryptoSymbol),
											A2(
												_elm_lang$core$Basics_ops['++'],
												' = ',
												A2(
													_elm_lang$core$Basics_ops['++'],
													A2(_cuducos$elm_format_number$FormatNumber$format, _cuducos$elm_format_number$FormatNumber_Locales$usLocale, model.amount * valueFiat),
													A2(
														_elm_lang$core$Basics_ops['++'],
														' ',
														_elm_lang$core$String$toUpper(fiat)))))))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _dymbe$whatismycryptoworth$Main$emptyIsNothing = function (string) {
	return _elm_lang$core$String$isEmpty(string) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(string);
};
var _dymbe$whatismycryptoworth$Main$init = {
	ctor: '_Tuple2',
	_0: {nameInput: '', fiatInput: '', amountInput: '', cryptoName: _elm_lang$core$Maybe$Nothing, cryptoSymbol: _elm_lang$core$Maybe$Nothing, fiat: _elm_lang$core$Maybe$Nothing, amount: 0, valueUSD: _elm_lang$core$Maybe$Nothing, valueFiat: _elm_lang$core$Maybe$Nothing},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _dymbe$whatismycryptoworth$Main$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {nameInput: a, fiatInput: b, amountInput: c, cryptoName: d, cryptoSymbol: e, fiat: f, amount: g, valueUSD: h, valueFiat: i};
	});
var _dymbe$whatismycryptoworth$Main$modelDecoder = A3(
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'nameInput',
									_elm_lang$core$Json_Decode$string,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_dymbe$whatismycryptoworth$Main$Model))))))))));
var _dymbe$whatismycryptoworth$Main$Response = F4(
	function (a, b, c, d) {
		return {name: a, symbol: b, valueUSD: c, valueFiat: d};
	});
var _dymbe$whatismycryptoworth$Main$decodeCryptoPrice = function (fiat) {
	return A2(
		_elm_lang$core$Json_Decode$index,
		0,
		A4(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'name',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_dymbe$whatismycryptoworth$Main$Response))))));
};
var _dymbe$whatismycryptoworth$Main$NewPrice = function (a) {
	return {ctor: 'NewPrice', _0: a};
};
var _dymbe$whatismycryptoworth$Main$getCryptoPrice = F2(
	function (crypto, fiat) {
		if (!_elm_lang$core$String$isEmpty(crypto)) {
			var url = A2(
				_elm_lang$core$Basics_ops['++'],
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					crypto,
					A2(_elm_lang$core$Basics_ops['++'], '/?convert=', fiat)));
			var request = A2(
				_elm_lang$http$Http$get,
				url,
				_dymbe$whatismycryptoworth$Main$decodeCryptoPrice(fiat));
			return A2(_elm_lang$http$Http$send, _dymbe$whatismycryptoworth$Main$NewPrice, request);
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _dymbe$whatismycryptoworth$Main$update = F2(
	function (msg, model) {
		var _p12 = msg;
		switch (_p12.ctor) {
			case 'ChangeCryptoName':
				return {
					ctor: '_Tuple2',
			...
			case 'GetCryptoPrice':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							fiat: _elm_lang$core$Maybe$Just(model.fiatInput),
							amount: _dymbe$whatismycryptoworth$Main$stringToFloatOrZero(model.amountInput)
						}),
					_1: A2(_dymbe$whatismycryptoworth$Main$getCryptoPrice, model.nameInput, model.fiatInput)
				};
			default:
				if (_p12._0.ctor === 'Ok') {
					var _p13 = _p12._0._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								cryptoName: _elm_lang$core$Maybe$Just(_p13.name),
								cryptoSymbol: _elm_lang$core$Maybe$Just(_p13.symbol),
								valueUSD: _dymbe$whatismycryptoworth$Main$stringToMaybeFloat(_p13.valueUSD),
								valueFiat: _dymbe$whatismycryptoworth$Main$stringToMaybeFloat(
									_dymbe$whatismycryptoworth$Main$stringOrEmpty(_p13.valueFiat))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var a = A2(_elm_lang$core$Debug$log, 'error', _p12._0._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{cryptoName: _elm_lang$core$Maybe$Nothing, cryptoSymbol: _elm_lang$core$Maybe$Nothing, valueUSD: _elm_lang$core$Maybe$Nothing, valueFiat: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
		}
	});
var _dymbe$whatismycryptoworth$Main$GetCryptoPrice = {ctor: 'GetCryptoPrice'};
var _dymbe$whatismycryptoworth$Main$ChangeFiat = function (a) {
	return {ctor: 'ChangeFiat', _0: a};
};
var _dymbe$whatismycryptoworth$Main$ChangeCryptoAmount = function (a) {
	return {ctor: 'ChangeCryptoAmount', _0: a};
};
var _dymbe$whatismycryptoworth$Main$ChangeCryptoName = function (a) {
	return {ctor: 'ChangeCryptoName', _0: a};
};
var _dymbe$whatismycryptoworth$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_dymbe$whatismycryptoworth$Main$inputRow, 'Crypto amount:', 'Enter amount...', _dymbe$whatismycryptoworth$Main$ChangeCryptoAmount),
				_1: {
					ctor: '::',
					_0: A3(_dymbe$whatismycryptoworth$Main$inputRow, 'Preferred fiat:', 'e.g. USD, EUR...', _dymbe$whatismycryptoworth$Main$ChangeFiat),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_dymbe$whatismycryptoworth$Main$GetCryptoPrice),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Get value'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _dymbe$whatismycryptoworth$Main$resultRow(model),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _dymbe$whatismycryptoworth$Main$main = _elm_lang$html$Html$program(
	{init: _dymbe$whatismycryptoworth$Main$init, update: _dymbe$whatismycryptoworth$Main$update, subscriptions: _dymbe$whatismycryptoworth$Main$subscriptions, view: _dymbe$whatismycryptoworth$Main$view})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _dymbe$whatismycryptoworth$Main$main !== 'undefined') {
    _dymbe$whatismycryptoworth$Main$main(Elm['Main'], 'Main', undefined);
}
